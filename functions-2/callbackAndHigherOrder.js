...
// CODE HERE
const multiply = (num1, num2, answer) => num1 * num2;
...
// CODE HERE
uniq(names, uniqArr) console.log('The new names array with all the duplicate items removed is [UNIQARRPARAM].')
